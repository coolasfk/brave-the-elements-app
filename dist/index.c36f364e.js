...
let getWeather = navigator.geolocation.getCurrentPosition((position)=>{
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=98cf5456a9a3e919f85b22a378be2b52&units=metric`).then((response)=>response.json()).then((position)=>{
        addWeather(position);
